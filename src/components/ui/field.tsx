...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: shadcn Field component uses role="group" by design
    <div
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: shadcn FieldError uses index as key by design
